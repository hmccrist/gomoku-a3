...
// logic for checking if a Gomoku game is over - when given a board.


// copied from gomoku-react/src/utils/GomokuUtils.ts
...
// changed to just return a boolean
export function checkGomokuWin(grid: string[], gridSize: number, cellIndex: number, valueToCheck: string): boolean {
